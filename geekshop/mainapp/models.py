...
class Product(models.Model):
    ...
    name = models.CharField(verbose_name='имя продукта', max_length=25, unique=True)
    description = models.TextField(verbose_name='описание продукта', max_length=140, blank=True)
